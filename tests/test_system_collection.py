...
class SystemCollectionTests(unittest.TestCase):
    ...
    @patch("occams_beard.collectors.system.os.getloadavg", return_value=(0.5, 0.4, 0.3))
    ...
    @patch("occams_beard.collectors.system.os.getloadavg", return_value=(1.0, 0.8, 0.6))
