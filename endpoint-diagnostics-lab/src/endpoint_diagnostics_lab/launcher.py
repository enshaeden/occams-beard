...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="endpoint-diagnostics-lab-operator",
...
def launch_operator_interface(config: OperatorLauncherConfig) -> int:
    ...
    server_thread = threading.Thread(
        ...
        name="endpoint-diagnostics-lab-operator-server",
        daemon=True,
    )
    server_thread.start()
    ...
    print(f"Endpoint Diagnostics Lab operator interface is running at {browser_url}")
...
def _load_web_dependencies():
    ...
    try:
        app_module = importlib.import_module("endpoint_diagnostics_lab.app")
