...
from endpoint_diagnostics_lab.runner import build_run_options, run_diagnostics
...
def _run_command(args: argparse.Namespace) -> int:
    ...
    LOGGER.info("Running endpoint diagnostics for checks: %s", ", ".join(options.selected_checks))
    LOGGER.debug(
